...
- **`solution_evaluate`** (registered `server.ts:319#"'solution_evaluate'"`) — the producer. Runs preflight against
...
- **`solution_gate`** (registered `server.ts:339#"'solution_gate'"`) — read-only checker. Resolves current HEAD
