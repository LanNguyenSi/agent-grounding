...
- **`solution_evaluate`** (registered `server.ts:648#"'solution_evaluate'"`): the producer. Runs preflight against
...
- **`solution_gate`** (registered `server.ts:723#"'solution_gate'"`): read-only checker. Resolves current HEAD
