...
timestamp: 2026-09-22T06:28:10Z
sources:
  - README.md
  - CHANGELOG.md
  - package.json
...
- `@lannguyensi/understanding-gate` (tags `understanding-gate-vX.Y.Z`, published
  ...
  locked packages)
- `@lannguyensi/grounding-mcp` (`0.12.0`)
...
- Version numbers across packages carry no relationship: `grounding-mcp@0.12.0`
...
(`.github/workflows/ci.yml:449-465#"npm run check:grounding-mcp-pack"`) runs
