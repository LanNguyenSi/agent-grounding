...
Tasks for every phase are filed in `agent-tasks` under the `agent-grounding` project, externalRef pattern `ug-2026-04-29-*`. Phases 1, 2, 3 are filed as bundled tasks; they will be split into sub-tasks once the prior phase produces dogfood feedback.
